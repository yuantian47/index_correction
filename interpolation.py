    ...
    def __init__(self, directory, idx_range, xdim, ydim, zdim, xlength,
        ...
        mesh_frame = \
            o3d.geometry.TriangleMesh.create_coordinate_frame(size=1,
                                                              origin=[0, 0, 0])
        o3d.visualization.draw_geometries([self.top_smooth_pcd, mesh_frame])
        ...
        o3d.visualization.draw_geometries([self.bot_smooth_pcd, mesh_frame])
        self.seg.ray_tracing(np.repeat([[0.0, 0.0, 1.0]], np.asarray(
        ...
        o3d.visualization.draw_geometries(
            ...
            window_name="smooth fit a sphere on bottom layer bss",
